        ...
        create(selectedUsers, userId, rooms, groupName, groupIcon) {
            ...
            if (selectedUsers.length === 1) {
                ...
                try {
                    ...
                    // Add default
                    roomJson['name'] = "名称未設定";
                    roomJson['room_icon'] = "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-profile-icon.jpeg?alt=media&token=d161ba6c-1112-4cba-b538-0f650943ef9f"
                    ...
                    room = {
                        image: "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-profile-icon.jpeg?alt=media&token=d161ba6c-1112-4cba-b538-0f650943ef9f",
                        name: "名称未設定",
                        id: newRoom.key,
                        msgs: [],
                        isMute: false,
