import { database, firebaseApp } from '../firebase/index';
import { databese, storage } from '../firebase/index';
...
/**
 * Update firebase realtime datebase
 * @param {object} updateJson The keys are full paths to data tobe updated. The values are updated values.
 * @returns {Promise}
 */
