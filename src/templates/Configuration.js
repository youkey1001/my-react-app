    ...
    async componentDidMount() {
        ...
        const changeRooms = async (snapshot, type) => {
            ...
            if (isPrivate) {
                ...
                roomIcon = (partnerValue.photoPath) ? partnerValue.photoPath : "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-profile-icon.jpeg?alt=media&token=d161ba6c-1112-4cba-b538-0f650943ef9f";
            } else {
