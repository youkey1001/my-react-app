    ...
    async componentDidMount() {
        const queryUserPhoto = (id) => {
            return new Promise(resolve => {
                return this.userRef.child(id).once('value', (snapshot) => {
                    const userPhoto = (snapshot.val().photoPath) ? snapshot.val().photoPath : "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-profile-icon.jpeg?alt=media&token=d161ba6c-1112-4cba-b538-0f650943ef9f"
        ...
        const changeRooms = async (snapshot, type) => {
            ...
            let rooms = this.props.messages.rooms,
                ...
                msgs = [],
                hasNotRead = 0,
                icon = (roomValue.room_icon) ? roomValue.room_icon : "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-image-square.png?alt=media&token=a8680af5-9e31-436b-9dfa-7b67c5b4724f";
        ...
        this.userRef.orderByKey().on('child_added', async (snapshot) => {
            ...
            const userJson = {
                id: userId,
                name: userValue.name,
                image: (userValue.photoPath) ? userValue.photoPath : "https://firebasestorage.googleapis.com/v0/b/react-chat-e2fd7.appspot.com/o/no-profile-icon.jpeg?alt=media&token=d161ba6c-1112-4cba-b538-0f650943ef9f",
            };
